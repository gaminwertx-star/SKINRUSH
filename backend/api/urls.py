...
urlpatterns = [
    ...
    path("admin/topup-chats/<int:pk>/send/", admin_api.admin_topup_send, name="admin-topup-send"),
    path("admin/topup-chats/<int:pk>/pay/", admin_api.admin_topup_pay, name="admin-topup-pay"),
    path("admin/topup-chats/<int:pk>/close/", admin_api.admin_topup_close, name="admin-topup-close"),
