...
urlpatterns = [
    ...
    path("admin/cases/<int:pk>/items/", admin_api.admin_case_items, name="admin-case-items"),
    path("admin/case-items/<int:pk>/", admin_api.admin_case_item_detail, name="admin-case-item-detail"),
    ...
    path("admin/users/<int:pk>/ban/", admin_api.admin_user_ban, name="admin-user-ban"),
    path("admin/users/<int:pk>/give-skin/", admin_api.admin_give_skin, name="admin-give-skin"),
    path("admin/users/<int:pk>/take-skin/", admin_api.admin_take_skin, name="admin-take-skin"),
    path("admin/users/<int:pk>/free-case/", admin_api.admin_give_free_case, name="admin-free-case"),
    path("admin/users/<int:pk>/message/", admin_api.admin_message_user, name="admin-message-user"),
    path("admin/skins/", admin_api.admin_skin_search, name="admin-skin-search"),
    path("admin/audit/", admin_api.admin_audit, name="admin-audit"),
    ...
    path("admin/partners/", admin_api.admin_partners, name="admin-partners"),
    path("admin/partner-withdraws/<int:pk>/pay/", admin_api.admin_partner_withdraw_pay,
         name="admin-partner-withdraw-pay"),
