...
urlpatterns = [
    ...
    path("hamkorlik/", pages.hamkorlik, name="hamkorlik"),
    path("hamkorlik/yaratish/", pages.hamkorlik_create, name="hamkorlik-create"),
    path("hamkorlik/chiqarish/", pages.hamkorlik_withdraw, name="hamkorlik-withdraw"),
